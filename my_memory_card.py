...
questions_list = [] 
questions_list.append(Question('В каком году вышел Fallout Shelter', '2015', '2013', '2010', '2016'))
questions_list.append(Question('В каком году вышел MInecraft', '2011', '2009', '2010', '2014'))
questions_list.append(Question('Кто автор Minecraft', 'Нотч', 'Джон', 'Джеймс', 'Стив'))
questions_list.append(Question('Как называется компания в игре Fallout Shelter', 'Волт-тек', 'Супер-Убежище', 'pop-company', 'никак'))
questions_list.append(Question('В каком году вышел Plants VS Zombies', '2009', '2013', '2008', '2011'))
questions_list.append(Question('Какого персонажа поменяли в Plants VS Zombie', 'Майкла Джексона', 'Гаргантюа', 'зомби с флагом', 'нет правильного ответа'))
questions_list.append(Question('Сколько версий Minecraftа', '2', '1', '3', '4'))
questions_list.append(Question('сколько версий Plants VS zombie', '3', '2', '1', '4'))
questions_list.append(Question('Сколько персонажей в Subway Surfers', '19', '14', '16', '18'))
questions_list.append(Question('В каком году вышел Subway Surfers', '2012', '2011', '2013', '2010'))
